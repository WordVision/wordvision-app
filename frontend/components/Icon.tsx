      ...
      return (
        ...
        >
          ...
          <Path
            ...
            d="M119.019 110.269c0 2.911-1.181 5.545-3.089 7.453a10.507 10.507 0 0 1-7.453 3.089H59.352c2.91 0 5.545-1.181 7.453-3.089a10.508 10.508 0 0 0 3.089-7.453c0-5.823-4.72-10.542-10.542-10.542h49.125c5.822 0 10.542 4.719 10.542 10.542ZM76.226 96.62a10.508 10.508 0 0 0 7.454 3.089H34.556a10.508 10.508 0 0 1-7.454-3.089 10.508 10.508 0 0 1-3.088-7.453c0-5.823 4.72-10.542 10.542-10.542H83.68c-5.823 0-10.542 4.72-10.542 10.542 0 2.911 1.18 5.545 3.088 7.453Z"
          />
          <Path
            fill="#fff"
            stroke="#868C98"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M67.185 110.078v.38a8.328 8.328 0 0 1-8.327 8.328H25.92V101.75h32.937a8.328 8.328 0 0 1 8.327 8.328Z"
          />
          <Path
            fill="#CDD0D5"
            stroke="#868C98"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M69.893 110.268c0 2.911-1.18 5.546-3.088 7.453a10.506 10.506 0 0 1-7.454 3.089H24.014v-2.025h34.844a8.327 8.327 0 0 0 8.327-8.327v-.38a8.328 8.328 0 0 0-8.327-8.328H24.014v-2.024H59.35c5.823 0 10.542 4.719 10.542 10.542Z"
          />
          <Path
            fill="#fff"
            stroke="#868C98"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M117.11 80.653v17.031H84.173a8.324 8.324 0 0 1-8.327-8.323v-.385a8.324 8.324 0 0 1 8.327-8.323h32.937Z"
          />
          <Path
            fill="#CDD0D5"
            stroke="#868C98"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M75.846 88.976v.385a8.324 8.324 0 0 0 8.327 8.323h34.844v2.025H83.68c-2.912 0-5.546-1.181-7.454-3.089a10.507 10.507 0 0 1-3.088-7.453c0-5.823 4.72-10.542 10.542-10.542h35.337v2.028H84.173a8.324 8.324 0 0 0-8.327 8.323ZM49.5 125.832l-4.599-4.351-4.598 4.351v-14.02H49.5v14.02Z"
          />
          <Path
            stroke="#868C98"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M20.814 71.088s-6 .02-6 6c0-5.98-6-6-6-6s6-.02 6-6c0 5.98 6 6 6 6ZM88.814 13.088s-6 .02-6 6c0-5.98-6-6-6-6s6-.02 6-6c0 5.98 6 6 6 6Z"
          />
          <Rect
            width={76.842}
            height={49.379}
          ...
          <Path
            fill="#868C98"
            fillRule="evenodd"
            d="M43.154 55.933a6.612 6.612 0 0 1 13.167 0 10.21 10.21 0 0 1-6.583 2.393c-2.507 0-4.803-.9-6.584-2.393Zm9.66-9.845a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
            clipRule="evenodd"
          />
          <Rect
            width={33.542}
          ...
          <Path
            fill="#868C98"
            d="m93.38 47.34 3.245 3.223-3.338 3.36a.874.874 0 1 0 1.24 1.233l3.955-3.98a.874.874 0 0 0-.004-1.237l-3.865-3.84a.875.875 0 0 0-1.233 1.241ZM117.348 46.023l-3.84 3.866a.88.88 0 0 0-.254.619c.001.23.095.455.258.617l3.981 3.955a.874.874 0 1 0 1.232-1.241l-3.36-3.338 3.223-3.245a.874.874 0 1 0-1.24-1.233ZM99.8 61.853l12.475-.041a.875.875 0 0 0-.005-1.749l-12.475.041a.874.874 0 1 0 .006 1.75Z"
          />
        </Svg>
      );
